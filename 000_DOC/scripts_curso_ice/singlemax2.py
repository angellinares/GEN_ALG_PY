...
toolbox.register("select2", tools.selBest) # selecciona basada en 
...
def main():
	...
	for g in range(NGEN):
		...
		k1 = int(0.8 * len(pop))
		k2 = int(0.2 * len(pop))
		offspring1 = toolbox.select(pop, k1) # seleccion basada en tournament
		offspring2 = toolbox.select2(pop, k2) # seleccion basada en elitismo
